...
static DEFINE_SPINLOCK(scull_u_lock);// = SPIN_LOCK_UNLOCKED;
...
static DEFINE_SPINLOCK(scull_w_lock);// = SPIN_LOCK_UNLOCKED;
...
static DEFINE_SPINLOCK(scull_c_lock);// = SPIN_LOCK_UNLOCKED;
